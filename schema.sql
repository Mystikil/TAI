...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `skill_blacksmithing` int unsigned NOT NULL DEFAULT 10,
  `skill_blacksmithing_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_farming` int unsigned NOT NULL DEFAULT 10,
  `skill_farming_tries` bigint unsigned NOT NULL DEFAULT 0,
  `skill_jewelcrafting` int unsigned NOT NULL DEFAULT 10,
  `skill_jewelcrafting_tries` bigint unsigned NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
